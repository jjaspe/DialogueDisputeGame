...
namespace DialogueDisputeGameMultiplayer.Offline
{
    ...
    {
        static OfflineServerManager myInstance = new OfflineServerManager();
        public static OfflineServerManager getInstance()
        {
            myInstance =myInstance ?? new OfflineServerManager();
            return myInstance;
        }
        ...
        void RunServer()
        {
            ...
            FeedbackWriter.WriteLine(" Configuration Name: ");
            FeedbackWriter.WriteLine(" End point address: ");
            FeedbackWriter.WriteLine(" End point binding: ");
            FeedbackWriter.WriteLine(" End point contract: ");
            FeedbackWriter.WriteLine(" End point name: ");
            FeedbackWriter.WriteLine(" End point lisent uri: ");
            FeedbackWriter.WriteLine(" \nName:");
            FeedbackWriter.WriteLine(" Namespace: ");
            FeedbackWriter.WriteLine(" Service Type: ");
        }
        ...
        CharacterData addExtraProperties(CharacterData character)
        {
            if (character != null && character.MyAttributes != null)
            {
                ...
                if (!character.MyStats.ContainsKey("subterfugePenalty"))
                    character.MyStats.Add("subterfugePenalty", 0);
                if (!character.MyStats.ContainsKey("nonSubterfugePenalty"))
                    character.MyStats.Add("nonSubterfugePenalty", 0);
